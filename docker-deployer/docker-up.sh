...
tar cvfz $GZ_FILE /home/raychorn/__projects/portainer-ce/docker/pi-hole/etc-pihole
...
tar cvfz $GZ_FILE /home/raychorn/__projects/portainer-ce/docker/pi-hole/etc-dnsmasq.d
docker cp $GZ_FILE $CID:/workspaces/$GZ_FILE
